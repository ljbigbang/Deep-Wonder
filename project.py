...
def render_svg(svg):
    ...
    html = (
        r"""
        <div align="center">
        <img src="data:image/svg+xml;base64,%s" alt="SVG Image" style="width:23vw; float:left;"/>
        </div>
        """
        % b64
    )
...
def page_two():
    ...
    with st.container():
        ...
        col4.markdown("<p style='text-align: center;font-size:3vw;'>Introduction</p>", unsafe_allow_html=True)
        col4.markdown(
            "<p style='font-size:1.5vw;'>DeepDefinite, a Deep Learning-based Widefield Neuron Finder with Self-supervi-<br>sion, is a pioneering tool for eliminating fluctuating background in one-photon<br>calcium imaging via self-supervised learning. This website offers the facility to<br>upload your captured one-photon images for swift online processing or to peruse<br>our preloaded demo datasets. Furthermore, DeepDefinite can be conveniently<br>downloaded as a Fiji plugin, thereby circumventing the need for a Python environ-<br>ment, or the complete software can be operated directly from our GitHub reposito-<br>ry: <a href='https://github.com/songxf1011/SSFA.'>https://github.com/songxf1011/SSFA.</a></p>",
            unsafe_allow_html=True)
